...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 p-5 col-md-12">
        <form action="/admin/users/updateAka/<?= $post["postID"]; ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select class="custom-select <?= ($validation->hasError('category')) ? "is-invalid" : ""; ?>" name="category" id="inputGroupSelect01">
                        ...
                        <option value="Volunteer" <?= ($post["category"] === "Volunteer") ? "selected" : ""; ?>>Volunteer</option>
                        <div class="invalid-feedback">
